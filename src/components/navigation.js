...
export default class Navigation extends AbstractComponent {
  constructor({watchlist, history, favorites}) {
    super();
    this._favorites = favorites.length;
    this._watchlist = watchlist;
    this._history = history.length;
  }
  getTemplate() {
    ...
    <a href="#history" data-nav-type="history" class="main-navigation__item">History <span class="main-navigation__item-count">${this._history}</span></a>
